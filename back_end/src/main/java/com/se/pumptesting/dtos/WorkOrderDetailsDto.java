...
public class WorkOrderDetailsDto {
	...
	private String workorderpoReference;
	...
	public String getWorkordercustomerName() {

		return workordercustomerName;
	}

	public void setWorkordercustomerName(String workordercustomerName) {

		this.workordercustomerName = workordercustomerName;
	}

	public String getWorkorderprojectName() {

		return workorderprojectName;
	}

	public void setWorkorderprojectName(String workorderprojectName) {

		this.workorderprojectName = workorderprojectName;
	}

	public String getWorkorderpoReference() {

		return workorderpoReference;
	}

	public void setWorkorderpoReference(String workorderpoReference) {

		this.workorderpoReference = workorderpoReference;
	}
